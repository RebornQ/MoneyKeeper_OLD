package me.bakumon.moneykeeperclone.view.mpchartpatch.barchart;
 ...
 */
public class RoundBarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    public RoundBarChartRenderer(BarDataProvider chart, ChartAnimator animator,
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        for (int j = 0; j < buffer.size(); j += 4) {
            ...
            c.drawRoundRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2], buffer.buffer[j + 3],
                    (float) 25, (float) 25, mRenderPaint);
            c.drawRect(buffer.buffer[j], buffer.buffer[j + 1] + 25, buffer.buffer[j + 2], buffer.buffer[j + 3],
                    mRenderPaint);

            if (drawBorder) {
                // 上方圆角
                c.drawRoundRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2], buffer.buffer[j + 3],
                        (float) 25, (float) 25, mBarBorderPaint);
                c.drawRect(buffer.buffer[j], buffer.buffer[j + 1] + 25, buffer.buffer[j + 2], buffer.buffer[j + 3],
                        mBarBorderPaint);
