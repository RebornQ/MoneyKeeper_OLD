 ...
 */
class RecordsByMoneyViewBinder constructor(private val onDeleteClickListener: ((RecordForList) -> Unit)) :
    ItemViewBinder<RecordForList, RecordsByMoneyViewBinder.ViewHolder>() {
