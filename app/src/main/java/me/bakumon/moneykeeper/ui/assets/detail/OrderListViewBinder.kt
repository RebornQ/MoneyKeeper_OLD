 ...
 */
class OrderListViewBinder constructor(private val onDeleteClickListener: ((RecordForList) -> Unit)) :
    ItemViewBinder<RecordForList, OrderListViewBinder.ViewHolder>() {

    override fun onCreateViewHolder(inflater: LayoutInflater, parent: ViewGroup): ViewHolder {
        val root = inflater.inflate(R.layout.item_order_list, parent, false)
