 ...
 */
class TypeListViewBinder constructor(private val onLongClickItemListener: ((RecordType) -> Unit)) :
    ItemViewBinder<RecordType, TypeListViewBinder.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, item: RecordType) {
        ...
        holder.llItemRecordType.setOnClickListener {
            AddTypeActivity.open(holder.llItemRecordType.context, type = item.type, recordType = item)
        }
